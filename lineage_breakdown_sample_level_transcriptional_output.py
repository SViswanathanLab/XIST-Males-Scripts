...
for all_classes in entire_dataset:
    ...
    sns.stripplot(data=final_df, color="black", s=1.5, ax=ax, jitter=0.2, edgecolor="none", alpha=0.9, zorder=100, linewidth=0.15)
    ...
    if geneset_of_interest == "ESCAPE":
        ...
        ax.set_ylabel("Normalized Non-Escapee to\nAutosomal Gene Expression (log$_2$Ratio)")
    ...
    while a<len(final_df.columns.tolist()):
        add_stat_annotation(ax, data=final_df,
                        ...
                        test='Mann-Whitney', text_format='full', loc='outside', verbose=2, text_offset=0.07, line_offset_to_box=1/20, line_offset=0.01, fontsize=8)
        a=a+2
...
if geneset_of_interest == "ESCAPE":
    ...
    if main_interest == "MALES":
        ...
        plt.savefig("/Users/ananthansadagopan/Documents/ViswanathanLab/XIST_Males/MALES_lineage_breakdown_of_nonescaping_v_escaping_no_segment_normalization_all_categories.png", dpi=dpi_set)
        plt.savefig("/Users/ananthansadagopan/Documents/ViswanathanLab/XIST_Males/MALES_lineage_breakdown_of_nonescaping_v_escaping_no_segment_normalization_all_categories.pdf", dpi=dpi_set)
        
    elif main_interest == "FEMALES":
      
        plt.savefig("/Users/ananthansadagopan/Documents/ViswanathanLab/XIST_Males/FEMALES_lineage_breakdown_of_nonescaping_v_escaping_no_segment_normalization_all_categories.png", dpi=dpi_set)
        plt.savefig("/Users/ananthansadagopan/Documents/ViswanathanLab/XIST_Males/FEMALES_lineage_breakdown_of_nonescaping_v_escaping_no_segment_normalization_all_categories.pdf", dpi=dpi_set)
        
elif geneset_of_interest == "AUTOSOMAL":

    if main_interest == "MALES":
        
        plt.savefig("/Users/ananthansadagopan/Documents/ViswanathanLab/XIST_Males/MALES_lineage_breakdown_of_nonescaping_v_autosomal_no_segment_normalization_all_categories.png", dpi=dpi_set)
        plt.savefig("/Users/ananthansadagopan/Documents/ViswanathanLab/XIST_Males/MALES_lineage_breakdown_of_nonescaping_v_autosomal_no_segment_normalization_all_categories.pdf", dpi=dpi_set)
        
    elif main_interest == "FEMALES":
      
        plt.savefig("/Users/ananthansadagopan/Documents/ViswanathanLab/XIST_Males/FEMALES_lineage_breakdown_of_nonescaping_v_autosomal_no_segment_normalization_all_categories.png", dpi=dpi_set)
        plt.savefig("/Users/ananthansadagopan/Documents/ViswanathanLab/XIST_Males/FEMALES_lineage_breakdown_of_nonescaping_v_autosomal_no_segment_normalization_all_categories.pdf", dpi=dpi_set)
