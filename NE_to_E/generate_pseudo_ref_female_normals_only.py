...
df_RNA = pd.read_csv("../NE_to_E/Other_Input/female_normals_only_averaged_tcga_RSEM_gene_tpm.txt", sep="\t")
...
ne_df.to_csv("../NE_to_E/Output_Files/female_normals_ne_pseudo_reference_XISTneg_males.csv")
autosome_df.to_csv("../NE_to_E/Output_Files/female_normals_autosome_pseudo_reference_XISTneg_males.csv")
e_df.to_csv("../NE_to_E/Output_Files/female_normals_e_pseudo_reference_XISTneg_males.csv")
