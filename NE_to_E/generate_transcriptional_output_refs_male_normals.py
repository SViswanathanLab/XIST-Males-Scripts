...
df = pd.read_csv("../NE_to_E/Output_Files/skewness_male_normals_normalized_E_expression_TPM_geq0.csv")
...
df = pd.read_csv("../NE_to_E/Output_Files/skewness_male_normals_normalized_NE_expression_TPM_geq0.csv")
cols = df.columns.tolist()
...
df.to_csv("../NE_to_E/Output_Files/normals_only_MALES_resubset_09averaged_no_PAR_no_segment_mean_normalization_median_ne_e_pseudo_normalized_sample_level_ratio.csv", index=False)
