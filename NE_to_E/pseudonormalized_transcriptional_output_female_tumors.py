...
df_RNA = pd.read_csv("../NE_to_E/Other_Input/female_tumors_only_averaged_tcga_RSEM_gene_tpm.txt", sep="\t")
...
df_e_ref = pd.read_csv("../NE_to_E/Other_Input/e_pseudo_reference_XISTpos_females.csv")
df_ne_ref = pd.read_csv("../NE_to_E/Other_Input/ne_pseudo_reference_XISTpos_females.csv")
...
df_NE_out.to_csv("../NE_to_E/Output_Files/skewness_female_tumors_normalized_NE_expression_TPM_geq200.csv")

df_E_out = pd.DataFrame(new_E_rows).T
df_E_out.columns = df_high
df_E_out.index = df_autosome['gene_symbol'].tolist()

df_E_out.to_csv("../NE_to_E/Output_Files/skewness_female_tumors_normalized_E_expression_TPM_geq3.csv")
