...
df = pd.read_csv("/Users/ananthansadagopan/Documents/ViswanathanLab/full_TCGA/skewness_female_normals_normalized_E_expression_TPM_geq3_stddev_filtered_0.125.csv")
...
df = pd.read_csv("/Users/ananthansadagopan/Documents/ViswanathanLab/full_TCGA/skewness_female_normals_normalized_NE_expression_TPM_geq200_stddev_filtered_0.25.csv")
cols = df.columns.tolist()
...
df.to_csv("/Users/ananthansadagopan/Documents/ViswanathanLab/full_TCGA/normals_only_TPM_cutoff_stdev_filtered_3_0.125E_200_0.25NE_FEMALES_09averaged_no_PAR_no_segment_mean_normalization_median_ne_e_pseudo_normalized_sample_level_ratio.csv", index=False)
