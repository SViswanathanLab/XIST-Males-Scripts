...
df_NE_out.to_csv("../NE_to_E/Output_Files/skewness_male_normals_normalized_NE_expression_TPM_geq200.csv")

df_E_out = pd.DataFrame(new_E_rows).T
df_E_out.columns = df_high
df_E_out.index = df_autosome['gene_symbol'].tolist()

df_E_out.to_csv("../NE_to_E/Output_Files/skewness_male_normals_normalized_E_expression_TPM_geq3.csv")
