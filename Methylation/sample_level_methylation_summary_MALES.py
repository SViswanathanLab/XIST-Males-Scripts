...
while www<len(full_class_list):
    ...
    XISTpos_samples_ratio_df.to_csv("/Users/ananthansadagopan/Documents/ViswanathanLab/full_TCGA/NEW_male_tumors_sample_level_methylation_XISTpos_samples.csv", index=False)
    ...
    XISTpos_samples_ratio_df.to_csv("/Users/ananthansadagopan/Documents/ViswanathanLab/full_TCGA/NEW_male_tumors_sample_level_methylation_XISTneg_samples.csv", index=False)
