...
while a<len(shared_lineages):
    ...
    df2_temp = df2[df2['Classification']==shared_lineages[a]]
    ...
    female_temp_unp = df2_temp['XIST Expression (TPM)'].tolist()
    ...
    axs[a].hist(female_temp, density=False, color="#92DCE5", bins=bins_list, linewidth=0.5, edgecolor="none")
...
fig.savefig("/Users/ananthansadagopan/Documents/ViswanathanLab/XIST_Males/FEMALES_XIST_exp_by_lineage_CCLE_male_and_female_histogram.png", dpi=dpi_set, bbox_inches = 'tight')
fig.savefig("/Users/ananthansadagopan/Documents/ViswanathanLab/XIST_Males/FEMALES_XIST_exp_by_lineage_CCLE_male_and_female_histogram.pdf", dpi=dpi_set, bbox_inches = 'tight')
