...
(1) Install TITAN (https://github.com/GavinHaLab/TitanCNA_SV_WGS) and prepare a config file (example in: config_template.yaml). Note: Files used by the provided snakemake file are contained within this directory.
