...
df.to_csv("/Users/ananthansadagopan/Documents/ViswanathanLab/full_TCGA/male_normals_only_averaged_jhu-usc.edu_PANCAN_merged_HumanMethylation27_HumanMethylation450.betaValue_whitelisted.txt", sep="\t", index=False)